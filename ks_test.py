...
category_matrix=["C4","C41","C411","C42","C","E1","E11","E12","E121","E13",
"E131","E132","E14","E141","E142","E143","E2","E21","E211","E212","E3","E31","E311","E312","E313","E4","E41","E411","E5","E51","E511",
"E512","E513","E6","E61","E7","E71","E","G1","G15","G151","G152","G153","G154","G155","G156","G157","G158","G159","G","GCRIM","GDEF","GDIP","GDIS","GENT","GENV","GFAS","GHEA","GJOB","GOBIT","GODD","GPOL","GPRO","GREL","GSCI","GSPO","GTOUR",
...
for category in category_matrix:
    ...
    uni_order_score_ks=bench.quick_uniform(x_rel_train)

    uni_stamp_score_ks=bench.quick_uniform2(x_rel_train)
    ...
    for thresh in threshold:
        ...
        new_x_train,new_x_test=bench.transform_features(x_train,x_test,uni_order_score_ks,k)
    ...
    df["uniformO_p_ks"]=p_p
    df["uniformO_r_ks"]=r_r
    f1["uniformO_f1_ks"]=fm
    ...
    for thresh in threshold:
        k=math.floor(feature_amount*thresh/100)
        new_x_train,new_x_test=bench.transform_features(x_train,x_test,uni_stamp_score_ks,k)
    ...
    df["uniformS_p_ks"]=p_p
    df["uniformS_r_ks"]=r_r
    f1["uniformS_f1_ks"]= fm
    



    df.to_csv('csvs_revised/ks/' + category+'.csv', index=False)
    f1.to_csv('csvs_revised/ks/' + category+'.csv', index=False)